...
//             // var data = db.Spending_Details.Select(item => new
//             // {
//             //     item.Id,
//             //     item.SpendingId,
//             //     item.CreateTime,
...
//             //     }
//             // }).ToList();
//             var query = data.GroupBy(r => new { r.CreateTime.Year, r.CreateTime.Month, r.Spending.revenue_and_expenditure })
//              .Select(g => new { Year = g.Key.Year, Month = g.Key.Month, Name = g.Key.revenue_and_expenditure, Tổngthuchi = g.Sum(i => i.Spending.Money) })
...
//                 {
//                     sheet.Cells[rowIdx, 1].Value = item.Spending.Id;
//                     sheet.Cells[rowIdx, 2].Value = item.Spending.Purpose;
//                     sheet.Cells[rowIdx, 3].Value = item.Spending.Money;
...
//                     if (item.Spending.revenue_and_expenditure == 0)
//                     {
